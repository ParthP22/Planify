...
6. Now, you should be ready to run the app and log in! You do not need to create any of the collections or documents in the database manually. Firebase will handle it automatically.
